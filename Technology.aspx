<%@ Page Language="C#" MasterPageFile="~/GWMMaster.Master" AutoEventWireup="true"
    CodeBehind="Technology.aspx.cs" Inherits="GWMPortal.Technology" %>
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GrdCoPSessions" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered"
                            HeaderStyle-CssClass="navbar-default" AllowPaging="True" OnPageIndexChanging="GrdCoPSessions_PageIndexChanging" EmptyDataText="No Documents Available" PagerStyle-CssClass="grdviewPagerStyle"  Width="1271px">
                            <Columns>
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GrdWhitePapers" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered"
                            HeaderStyle-CssClass="navbar-default" AllowPaging="True" OnPageIndexChanging="GrdWhitePapers_PageIndexChanging" EmptyDataText="No Documents Available" PagerStyle-CssClass="grdviewPagerStyle">
                            <Columns>
                                <asp:BoundField HeaderText="Document Ref" DataField="id" />
                                <asp:BoundField HeaderText="Name" DataField="Name" />
                                <asp:BoundField HeaderText="Published Date" DataField="CreatedOn" DataFormatString="{0:dd/MMM/yyyy}" />
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GrdReports" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered"
                            HeaderStyle-CssClass="navbar-default" AllowPaging="True" OnPageIndexChanging="GrdReports_PageIndexChanging" EmptyDataText="No Documents Available" PagerStyle-CssClass="grdviewPagerStyle">
                            <Columns>
                                <asp:BoundField HeaderText="Document Ref" DataField="id" />
                                <asp:BoundField HeaderText="Name" DataField="Name" />
                                <asp:BoundField HeaderText="Published Date" DataField="CreatedOn" DataFormatString="{0:dd/MMM/yyyy}" />
